...
COPASI_CMAKE_OPTIONS="${COPASI_CMAKE_OPTIONS} -DCMAKE_TOOLCHAIN_FILE=/opt/toolchain-apple-darwin.cmake"
...
# build expat
  ...
  libSEDML)
    ...
    $CMAKE ${COPASI_CMAKE_OPTIONS} \
      ...
      -DLIBSBML_INCLUDE_DIR=${INSTALL_DIR}/include \
      -DLIBSBML_LIBRARY=${INSTALL_DIR}/lib/libsbml-static.a \
      -DLIBNUML_INCLUDE_DIR=${INSTALL_DIR}/include \
      -DLIBNUML_LIBRARY=${INSTALL_DIR}/lib/libnuml-static.a \
      -DEXTRA_LIBS=${INSTALL_DIR}/lib/libexpat.a \
      -DWITH_ZLIB=OFF \
